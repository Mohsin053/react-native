    ...
    <SafeAreaView style={{ backgroundColor: "white", flex: 1 }}>
      <View style={styles.uppertab}>
        <View style={styles.innertab}>
          ...
          <View style ={{height:40,borderRadius:10,width:'70%',elevation:5,backgroundColor:'#FF8216'}}>
            <Text
              style={{ fontSize: 20, fontWeight: "bold", color: "white" ,padding:5,alignSelf:'center'}}
            >
              Jobs Accepted | (2) 
            </Text>
          </View>
	  ...
	  <View style={styles.imageicon}>
		<View style={{width:'85%',
    }}><Text style={{fontSize:23,fontWeight:'bold',color:'white',margin:5}}>Hello! whoever</Text>
	<Text style={{fontSize:16,fontWeight:'bold',color:'white',margin:5}}>Let's find a story around you</Text></View>
      ...
      />
		...
		<TouchableOpacity
          ...
          >
            <Text
              style = {{color : activeScreenIndex === 0 ? "#FF8216" : "gray", fontSize:16,fontWeight:'bold' }}
            >Public Jobs</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text
              style = {{color : activeScreenIndex === 1 ? "#FF8216" : "gray", fontSize:16,fontWeight:'bold' }}
            >Your Jobs</Text>
          </TouchableOpacity>
        </View>
		<ScrollView
