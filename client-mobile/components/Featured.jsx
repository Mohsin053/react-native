...
const data = [
  { id: '1', name : 'Stephaine Liver', time : '1 Hour ago', profileimage: require("../assets/img1.png"), message : 'Natural market london is back to life', hashtag : '#London #UK' , videoimage: require("../assets/imgrect.png")  },
  { id: '2', name : 'your mom', time : '1 Hour ago', profileimage: require("../assets/img1.png"), message : 'Natural market london is back to life', hashtag : '#London #UK' , videoimage: require("../assets/imgrect.png")  },

  { id: '3', name : 'a hoe', time : '1 Hour ago', profileimage: require("../assets/img1.png"), message : 'Natural market london is back to life', hashtag : '#London #UK' , videoimage: require("../assets/imgrect.png")  },
...
export default function Featured({navigation}) {
  ...
  <View style={styles.contentbar}>
          ...
          <View style={styles.profileandstateview}>
            ...
            <TouchableOpacity style={styles.icon} onPress={() => navigation.navigate('BuyContent')}>
